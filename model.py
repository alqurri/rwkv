...
wkv_cuda = load(name="wkv", sources=["/scratch/aqa6122/rwk/Vision-RWKV-master/classification/mae/vrwkv/cuda/wkv_op.cpp", "/scratch/aqa6122/rwk/Vision-RWKV-master/classification/mae/vrwkv/cuda/wkv_cuda.cu"],
